...
@section('title','Tabel Kumpulan Halte')
@section('body')
...
@section('content')  
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Tabel Kumpulan Halte</h5>
     ...
     @section('content2')
            ...
            <div class="row">
                <div class="col s4 ">
                  <a class="btn-flat waves-effect accent-2 white-text red lighten-1" href="{{URL('isi-data2')}}"></i>Create</a>
@endsection
@endsection